...
M.setup = function()
    ...
    if config.add_default_keybindings then
        ...
        add_keymap('<leader>gf', ':PickMe git_log_file<cr>', 'File Commits')
        add_keymap('<leader>gl', ':PickMe git_log_line<cr>', 'Line Commits')
        add_keymap('<leader>gL', ':PickMe git_commits<cr>', 'Git Commit Log')
        ...
        add_keymap('<leader>ld', ':PickMe lsp_definitions<cr>', 'Definitions')
        add_keymap('<leader>lD', ':PickMe lsp_declarations<cr>', 'Declarations')
        add_keymap('<leader>lf', ':PickMe lsp_references<cr>', 'References')
        add_keymap('<leader>li', ':PickMe lsp_implementations<cr>', 'Implementations')
        add_keymap('<leader>lI', ':PickMe lsp_config<cr>', 'LSP Info')
        ...
        add_keymap('<leader>om', ':PickMe marks<cr>', 'Marks')
